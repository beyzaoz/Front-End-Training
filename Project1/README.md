...
This project is a responsive fitness website created based on the provided UI design.  
It is built using **HTML, CSS, and JavaScript** and follows all functional and visual requirements.
...
- Clicking a button:
  ...
  - Updates class image and content
- Class images are loaded from provided assets
...
- Hover effect works consistently for all trainers
...
- Based on entered height (cm) and weight (kg):
  - BMI is calculated dynamically
  - Indicator arrow moves to the correct BMI category
